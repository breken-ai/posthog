...
from posthog.api.project import ProjectBackwardCompatListSerializer, ProjectBackwardCompatSerializer, ProjectViewSet
...
class TestTeamProjectParity(BaseTest):
    ...
    def test_list_serializer_is_a_superset_of_team_basic_serializer(self):
        ...
        project_basic_fields = _serializer_field_names(ProjectBackwardCompatListSerializer)
