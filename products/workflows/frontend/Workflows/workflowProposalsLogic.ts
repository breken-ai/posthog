...
export interface workflowProposalsLogicActions {
    ...
    loadApplied: () => any;
    loadAppliedFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    loadAppliedSuccess: (appliedResponse: PaginatedWorkflowProposalListApi, payload?: any) => {
        appliedResponse: PaginatedWorkflowProposalListApi;
        payload?: any;
    };
    loadOptimisation: () => any;
    loadOptimisationFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    loadOptimisationSuccess: (optimisation: HogFlowOptimisationApi | null, payload?: any) => {
        optimisation: HogFlowOptimisationApi | null;
        payload?: any;
    };
    ...
    loadProposals: () => any;
    loadProposalsFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    loadProposalsSuccess: (proposalsResponse: PaginatedWorkflowProposalListApi, payload?: any) => {
    ...
    setOptimisationEnabledFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    setOptimisationEnabledSuccess: (optimisation: HogFlowOptimisationApi, payload?: {
        enabled: boolean;
    }) => {
    ...
    setOutcome: (proposalId: string, outcome: WorkflowProposalOutcomeApi) => {
        outcome: WorkflowProposalOutcomeApi;
        proposalId: string;
    };
    setResolvingId: (proposalId: string | null, action?: "approve" | "reject" | null) => {
...
export type workflowProposalsLogicType = MakeLogicType<workflowProposalsLogicValues, workflowProposalsLogicActions, WorkflowProposalsLogicProps, workflowProposalsLogicMeta>;
