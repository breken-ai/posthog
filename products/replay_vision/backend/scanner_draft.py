...
def _goal_entity_matches(
...
) -> tuple[list[_MatchedSurvey], list[_MatchedAction], list[_MatchedCohort]]:
    ...
    return list(surveys.values()), list(actions.values()), list(cohorts.values())
...
def draft_scanner_from_goal_v2(
    *,
    ...
    surveys, matched_actions, matched_cohorts = _goal_entity_matches(team, goal, user_access_control, allowed_scopes)
    if surveys:
    ...
    draft = _finalize_v2(
        ...
        allowed_cohorts=matched_cohorts,
    )
