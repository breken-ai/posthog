...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        SafeRemoveIndexConcurrently(model_name="task", name="posthog_task_team_created_idx"),
        SafeRemoveIndexConcurrently(model_name="task", name="posthog_task_team_activity_idx"),
