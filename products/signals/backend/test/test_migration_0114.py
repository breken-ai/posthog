...
# Non-atomic: 0113 creates its indexes CONCURRENTLY, which an atomic rewind cannot replay.
...
class BackfillReportStalenessClocksMigrationTest(NonAtomicTestMigrations):
    ...
    migrate_from = "0113_signalreport_staleness_indexes"
    migrate_to = "0114_backfill_report_staleness_clocks"
