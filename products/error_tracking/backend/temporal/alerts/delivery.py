...
evaluation, and status transitions also edit the root in place. Delivered
notification ids are recorded on the thread row so workflow retries never
double-post. The alert's stored filters gate openers (see filtering.py).
"""
